	...
	const categories = [
		{
			...
			links: [
				...
				{ href: '/sea-of-thieves-esp/', labelKey: 'homeSeo.linkEsp' },
				{ href: '/sea-of-thieves-aimbot/', labelKey: 'homeSeo.linkAimbot' },
				{ href: '/sea-of-thieves-radar-hack/', labelKey: 'homeSeo.linkRadar' },
			],
		},
		{
