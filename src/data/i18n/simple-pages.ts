...
export const simplePageCopy: Partial<Record<PageId, SimplePageCopy>> = {
		...
		sections: [
			{
				...
				list: ['Player boxes & distance', 'Loot and ship and player markers', 'Heli and Bradley filters'],
			},
			{
				h2: 'Aimbot & soft aim',
				paragraphs: [
	...
	'sea-of-thieves-esp': page({
		title: 'Sea of Thieves ESP | Wallhack & Player Boxes | {brand}',
		description:
			'Sea of Thieves ESP wallhack — player boxes, ship and player markers & distance tags on PC. Undetected cheats with aimbot & radar. Shop at seaofthievescheats.com.',
		h1: 'ESP',
		intro: 'See players and loot through walls during Sea of Thieves matches. Part of the same {brand} license.',
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'Sea of Thieves Cheats overview',
		ctaSecondaryHref: '/',
	...
	'sea-of-thieves-aimbot': page({
		title: 'Sea of Thieves Aimbot | Soft Aim & FOV Settings | {brand}',
		description:
			'Sea of Thieves aimbot with soft aim, FOV, bone priority & hotkeys on PC. Undetected {brand} with ESP & radar included. seaofthievescheats.com.',
		h1: 'Aimbot',
		intro: 'Soft aim and aim assist you can tune for Sea of Thieves. Included in the same {brand} license.',
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'Sea of Thieves Cheats overview',
		ctaSecondaryHref: '/',
	...
	radar: page({
		title: 'Sea of Thieves Radar Hack | 2D Threat Map | {brand}',
		description:
			'2D radar hack for flank awareness on PC. Bundled with ESP wallhack & soft aim in one license. EAC maintenance at seaofthievescheats.com.',
		h1: 'Radar',
