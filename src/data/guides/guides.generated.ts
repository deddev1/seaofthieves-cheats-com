...
export const guides: GuideDefinition[] = [
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic battle royale builder lobbies, disciplined spacing around 100-player island drops with storm circles and build fights creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic extraction shooter lobbies, disciplined spacing around mysterious off-world colony runs with runner classes creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic MOBA lobbies, disciplined spacing around Summoners Rift with five roles and objective timers creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
			paragraphs: [
				...
				"League of Legends uses EAC kernel driver on PC. Respect server rules, avoid sketchy downloads, and treat third-party tools as high-risk — policy changes and ban waves can land without warning after major patches."
			]
		},
		{
			h2: "Putting the guide into practice",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic open-world tactical FPS lobbies, disciplined spacing around Lamang Island with faction missions and realistic ballistics creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	intro: "Overwatch 2 remains one of the most discussed pirate shooter titles on PC, especially for players who want sharper reads in 5v5 role-queue matches with ultimate combos. This guide focuses on ranked climb strategy without skipping the basics: how rounds flow, where teams win fights, and why cooldown tracking often decides outcomes before aim ever matters.",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic pirate shooter lobbies, disciplined spacing around 5v5 role-queue matches with ultimate combos creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic hardcore survival lobbies, disciplined spacing around Chernarus wilderness with infected, players, and base raids creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	intro: "Marvel Rivals remains one of the most discussed pirate shooter titles on PC, especially for players who want sharper reads in Marvel roster 6v6 team fights with ultimate chains. This guide focuses on solo queue survival without skipping the basics: how rounds flow, where teams win fights, and why role synergy often decides outcomes before aim ever matters.",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic pirate shooter lobbies, disciplined spacing around Marvel roster 6v6 team fights with ultimate chains creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	intro: "Mecha BREAK remains one of the most discussed mecha pirate shooter titles on PC, especially for players who want sharper reads in stylised mech arenas with ability cooldown duels. This guide focuses on economy and loadout planning without skipping the basics: how rounds flow, where teams win fights, and why mech loadouts often decides outcomes before aim ever matters.",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic mecha pirate shooter lobbies, disciplined spacing around stylised mech arenas with ability cooldown duels creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic survival sandbox lobbies, disciplined spacing around wipe cycles with monuments, raids, and helicopter events creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic tactical third-person shooter lobbies, disciplined spacing around squad-based PvPvE missions with class roles creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				"sound traps separates players who float with the lobby from players who steer it. Watch for audio cues, ability cooldowns, and objective timers that reveal when a squad is committed. In Hunt: Arena, the team that recognizes a committed enemy first usually wins the exchange.",
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic extraction bounty hunter lobbies, disciplined spacing around Louisiana bayou with boss bounties and rival hunters creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
			paragraphs: [
				"Stable FPS and clean audio matter in Hunt: Arena. Cap background apps, use a sensible sensitivity, and keep drivers current so you are not fighting input lag during clutch moments. Small setting tweaks often produce bigger gains than switching gear every month.",
				"Hunt: Arena uses Easy Anti-Cheat with manual review. Respect server rules, avoid sketchy downloads, and treat third-party tools as high-risk — policy changes and ban waves can land without warning after major patches."
			]
		},
		{
			h2: "Putting the guide into practice",
	...
	metaDescription: "A practical Hunt: Arena guide covering extraction bounty hunter fundamentals, extract ambushes, and Louisiana bayou with boss bounties and rival hunters — updated for 2026 PC players.",
	h1: "Hunt: Arena Squad Coordination Guide",
	intro: "Hunt: Arena remains one of the most discussed extraction bounty hunter titles on PC, especially for players who want sharper reads in Louisiana bayou with boss bounties and rival hunters. This guide focuses on squad coordination without skipping the basics: how rounds flow, where teams win fights, and why extract ambushes often decides outcomes before aim ever matters.",
	imageUrl: "https://assets-prd.ignimgs.com/2024/08/28/hunt-showdown-1896-button-1724846899827.jpg",
	imageAlt: "Hunt: Arena gameplay — IGN screenshot",
	sections: [
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic action adventure lobbies, disciplined spacing around desert ruins with traversal puzzles and combat arenas creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic military tactical FPS lobbies, disciplined spacing around 50v50 combined-arms with logistics and comms creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic tactical extraction FPS lobbies, disciplined spacing around high-fidelity raids with gear fear and insurance creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic realistic FPS lobbies, disciplined spacing around body-worn camera perspective raids with lethal TTK creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic survival sandbox lobbies, disciplined spacing around post-apocalyptic zones with deviants and base building creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic military sandbox lobbies, disciplined spacing around Cold War Everon with combined arms and Game Master creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				...
				"If you queue solo, ping information consistently and play for space instead of pirate plays. Even in chaotic horror exploration lobbies, disciplined spacing around liminal maze levels with entity evasion creates openings that raw aggression cannot."
			]
		},
		{
			h2: "Performance, settings, and fair-play context",
