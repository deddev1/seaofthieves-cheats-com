...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} pirate — ESP and aimbot in Sea of Thieves', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'sea-of-thieves-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'sea-of-thieves-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for Sea of Thieves on PC' },
