 ...
 * `lastmod` reflects when EAC page's content actually changed — do NOT reset all
...
export const pageSitemapMeta: Record<PageId, PageSitemapMeta> = {
	home: { priority: 0.95, changefreq: 'daily', i18nPriority: 0.88, lastmod: '2026-08-31' },
	/** Money URL for "sea of thieves cheats" */
	hacks: { priority: 1.0, changefreq: 'weekly', i18nPriority: 0.9, lastmod: '2026-08-31' },
	undetected: { priority: 0.91, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-31' },
	'cheats-2026': { priority: 0.9, changefreq: 'weekly', i18nPriority: 0.85, lastmod: '2026-08-31' },
	...
	'best-cheats': { priority: 0.9, changefreq: 'weekly', i18nPriority: 0.85, lastmod: '2026-08-31' },
	...
	radar: { priority: 0.9, changefreq: 'weekly', i18nPriority: 0.85, lastmod: '2026-08-31' },
	eac: { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-31' },
	'sea-of-thieves-esp': { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-31' },
	'sea-of-thieves-aimbot': { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-31' },
	pricing: { priority: 0.94, changefreq: 'weekly', i18nPriority: 0.85, lastmod: '2026-08-31' },
	features: { priority: 0.9, changefreq: 'weekly', i18nPriority: 0.84, lastmod: '2026-08-31' },
	setup: { priority: 0.88, changefreq: 'weekly', i18nPriority: 0.84, lastmod: '2026-08-31' },
	updates: { priority: 0.93, changefreq: 'daily', i18nPriority: 0.85, lastmod: '2026-08-31' },
	faq: { priority: 0.8, changefreq: 'monthly', i18nPriority: 0.82, lastmod: '2026-08-31' },
	support: { priority: 0.8, changefreq: 'monthly', i18nPriority: 0.82, lastmod: '2026-08-31' },
