...
const TOPIC_LINKS = {
	...
	esp: { kind: 'page' as const, pageId: 'sea-of-thieves-esp' as const, labelKey: 'internalLinks.esp', label: L('{game} ESP & wallhack') },
	aimbot: { kind: 'page' as const, pageId: 'sea-of-thieves-aimbot' as const, labelKey: 'internalLinks.aimbot', label: L('{game} aimbot & soft aim') },
