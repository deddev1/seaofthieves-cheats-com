...
const SKIP_PATTERNS = [
	/-\d+w\.webp$/i,
	/sea-of-thieves-cheats-logo/i,
	/favicon/i,
];

async function optimizeHero() {
	const source = path.join(imagesDir, 'sea-of-thieves-esp-player-tags.webp');
...
console.log(`Done — ${heroResults.length} pirate + ${contentResults.length} content variants.`);
