...
const replacements = [
	['published by Facepunch', 'published by Rare'],
	['published by Facepunch', 'published by Rare'],
	['When Facepunch ships', 'When Rare ships'],
	...
	['monument zones and loot runs', 'arena sectors and sailing routes'],
	['Clear monument zones and loot runs', 'Clear arena sectors and sailing routes'],
	...
	['survival naval combats happen across open terrain', 'Map fights happen across open terrain'],
	['loot run', 'cashout route'],
	['loot runs', 'sailing routes'],
