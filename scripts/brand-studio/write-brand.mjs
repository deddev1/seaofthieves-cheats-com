...
export function validateBrandPayload(body) {
	...
	const logo = assetPath(b.logo ?? '/images/sea-of-thieves-cheats-logo.webp');
	const logoRaster = assetPath(b.logoRaster ?? '/images/sea-of-thieves-cheats-logo.png');
	const defaultOgImage = assetPath(b.defaultOgImage ?? '/images/sea-of-thieves-cheats-combat.webp');
	const heroImage = assetPath(b.heroImage ?? '/images/sot-hero-banner.webp');
