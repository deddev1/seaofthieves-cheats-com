...
const UI = {
	es: {
		...
		gallery: 'Aspecto en juego', buy: 'Comprar Sea of Thieves Cheats', viewStore: 'Ver tienda', setupGuide: 'Guía de instalación',
		checkStatus: 'Ver estado', overview: 'Resumen Sea of Thieves Cheats', viewFeatures: 'Ver funciones', contactSupport: 'Contactar soporte',
		inGame: 'Aspecto en juego', fullGuide: 'Sea of Thieves Cheats — Guía completa',
	},
	fr: {
		features: 'Fonctions', store: 'Boutique', status: 'Statut', setup: 'Installation', support: 'Support', faq: 'FAQ',
		gallery: 'Rendu en jeu', buy: 'Acheter Sea of Thieves Cheats', viewStore: 'Voir la boutique', setupGuide: "Guide d'installation",
		checkStatus: 'Voir le statut', overview: 'Aperçu Sea of Thieves Cheats', viewFeatures: 'Voir les fonctions', contactSupport: 'Contacter le support',
		inGame: 'Rendu en jeu', fullGuide: 'Sea of Thieves Cheats — Guide complet',
	},
	de: {
		features: 'Features', store: 'Shop', status: 'Status', setup: 'Setup', support: 'Support', faq: 'FAQ',
		gallery: 'Ingame-Ansicht', buy: 'Sea of Thieves Cheats kaufen', viewStore: 'Shop ansehen', setupGuide: 'Setup-Anleitung',
		checkStatus: 'Status prüfen', overview: 'Sea of Thieves Cheats Übersicht', viewFeatures: 'Features ansehen', contactSupport: 'Support kontaktieren',
		inGame: 'Ingame-Ansicht', fullGuide: 'Sea of Thieves Cheats — Vollständiger Guide',
	},
	pt: {
		features: 'Recursos', store: 'Loja', status: 'Status', setup: 'Instalação', support: 'Suporte', faq: 'FAQ',
		gallery: 'Visual in-game', buy: 'Comprar Sea of Thieves Cheats', viewStore: 'Ver loja', setupGuide: 'Guia de instalação',
		checkStatus: 'Ver status', overview: 'Visão geral Sea of Thieves Cheats', viewFeatures: 'Ver recursos', contactSupport: 'Contactar suporte',
		inGame: 'Visual in-game', fullGuide: 'Sea of Thieves Cheats — Guia completo',
	},
	it: {
		features: 'Funzioni', store: 'Negozio', status: 'Stato', setup: 'Setup', support: 'Supporto', faq: 'FAQ',
		gallery: 'Aspetto in-game', buy: 'Acquista Sea of Thieves Cheats', viewStore: 'Vedi negozio', setupGuide: 'Guida installazione',
		checkStatus: 'Controlla stato', overview: 'Panoramica Sea of Thieves Cheats', viewFeatures: 'Vedi funzioni', contactSupport: 'Contatta supporto',
		inGame: 'Aspetto in-game', fullGuide: 'Sea of Thieves Cheats — Guida completa',
	},
	nl: {
		features: 'Functies', store: 'Winkel', status: 'Status', setup: 'Setup', support: 'Support', faq: 'FAQ',
		gallery: 'In-game weergave', buy: 'Sea of Thieves Cheats kopen', viewStore: 'Winkel bekijken', setupGuide: 'Installatiegids',
		checkStatus: 'Status controleren', overview: 'Sea of Thieves Cheats overzicht', viewFeatures: 'Functies bekijken', contactSupport: 'Contact support',
		inGame: 'In-game weergave', fullGuide: 'Sea of Thieves Cheats — Volledige gids',
	},
	pl: {
		features: 'Funkcje', store: 'Sklep', status: 'Status', setup: 'Instalacja', support: 'Wsparcie', faq: 'FAQ',
		gallery: 'Wygląd w grze', buy: 'Kup Sea of Thieves Cheats', viewStore: 'Zobacz sklep', setupGuide: 'Przewodnik instalacji',
		checkStatus: 'Sprawdź status', overview: 'Przegląd Sea of Thieves Cheats', viewFeatures: 'Zobacz funkcje', contactSupport: 'Kontakt z supportem',
		inGame: 'Wygląd w grze', fullGuide: 'Sea of Thieves Cheats — Pełny przewodnik',
	},
	ru: {
		features: 'Функции', store: 'Магазин', status: 'Статус', setup: 'Установка', support: 'Поддержка', faq: 'FAQ',
		gallery: 'Вид в игре', buy: 'Купить Sea of Thieves Cheats', viewStore: 'Открыть магазин', setupGuide: 'Гайд по установке',
		checkStatus: 'Проверить статус', overview: 'Обзор Sea of Thieves Cheats', viewFeatures: 'Смотреть функции', contactSupport: 'Связаться с поддержкой',
		inGame: 'Вид в игре', fullGuide: 'Sea of Thieves Cheats — Полный гайд',
	},
	tr: {
		features: 'Özellikler', store: 'Mağaza', status: 'Durum', setup: 'Kurulum', support: 'Destek', faq: 'SSS',
		gallery: 'Oyun içi görünüm', buy: 'Sea of Thieves Cheats satın al', viewStore: 'Mağazayı gör', setupGuide: 'Kurulum rehberi',
		checkStatus: 'Durumu kontrol et', overview: 'Sea of Thieves Cheats genel bakış', viewFeatures: 'Özellikleri gör', contactSupport: 'Destekle iletişim',
		inGame: 'Oyun içi görünüm', fullGuide: 'Sea of Thieves Cheats — Tam rehber',
	},
	ar: {
		features: 'الميزات', store: 'المتجر', status: 'الحالة', setup: 'التثبيت', support: 'الدعم', faq: 'الأسئلة الشائعة',
		gallery: 'المظهر داخل اللعبة', buy: 'اشترِ Sea of Thieves Cheats', viewStore: 'عرض المتجر', setupGuide: 'دليل التثبيت',
		checkStatus: 'تحقق من الحالة', overview: 'نظرة عامة على Sea of Thieves Cheats', viewFeatures: 'عرض الميزات', contactSupport: 'اتصل بالدعم',
		inGame: 'المظهر داخل اللعبة', fullGuide: 'Sea of Thieves Cheats — دليل كامل',
	},
	ja: {
		features: '機能', store: 'ストア', status: 'ステータス', setup: 'セットアップ', support: 'サポート', faq: 'FAQ',
		gallery: 'ゲーム内の見た目', buy: 'Sea of Thieves Cheatsを購入', viewStore: 'ストアを見る', setupGuide: 'セットアップガイド',
		checkStatus: 'ステータスを確認', overview: 'Sea of Thieves Cheats概要', viewFeatures: '機能を見る', contactSupport: 'サポートに連絡',
		inGame: 'ゲーム内の見た目', fullGuide: 'Sea of Thieves Cheats — 完全ガイド',
	},
	ko: {
		features: '기능', store: '스토어', status: '상태', setup: '설치', support: '지원', faq: 'FAQ',
		gallery: '인게임 화면', buy: 'Sea of Thieves Cheats 구매', viewStore: '스토어 보기', setupGuide: '설치 가이드',
		checkStatus: '상태 확인', overview: 'Sea of Thieves Cheats 개요', viewFeatures: '기능 보기', contactSupport: '지원 문의',
		inGame: '인게임 화면', fullGuide: 'Sea of Thieves Cheats — 전체 가이드',
	},
	zh: {
		features: '功能', store: '商店', status: '状态', setup: '安装', support: '支持', faq: '常见问题',
		gallery: '游戏内效果', buy: '购买 Sea of Thieves Cheats', viewStore: '查看商店', setupGuide: '安装指南',
		checkStatus: '查看状态', overview: 'Sea of Thieves Cheats概览', viewFeatures: '查看功能', contactSupport: '联系支持',
		inGame: '游戏内效果', fullGuide: 'Sea of Thieves Cheats — 完整指南',
	},
	hi: {
		features: 'फ़ीचर्स', store: 'स्टोर', status: 'स्टेटस', setup: 'सेटअप', support: 'सहायता', faq: 'FAQ',
		gallery: 'इन-गेम लुक', buy: 'Sea of Thieves Cheats खरीदें', viewStore: 'स्टोर देखें', setupGuide: 'सेटअप गाइड',
		checkStatus: 'स्टेटस जांचें', overview: 'Sea of Thieves Cheats अवलोकन', viewFeatures: 'फ़ीचर्स देखें', contactSupport: 'सहायता से संपर्क',
		inGame: 'इन-गेम लुक', fullGuide: 'Sea of Thieves Cheats — पूर्ण गाइड',
	},
	id: {
		features: 'Fitur', store: 'Toko', status: 'Status', setup: 'Setup', support: 'Dukungan', faq: 'FAQ',
		gallery: 'Tampilan in-game', buy: 'Beli Sea of Thieves Cheats', viewStore: 'Lihat toko', setupGuide: 'Panduan setup',
		checkStatus: 'Cek status', overview: 'Ringkasan Sea of Thieves Cheats', viewFeatures: 'Lihat fitur', contactSupport: 'Hubungi dukungan',
		inGame: 'Tampilan in-game', fullGuide: 'Sea of Thieves Cheats — Panduan lengkap',
	},
	th: {
		features: 'ฟีเจอร์', store: 'ร้านค้า', status: 'สถานะ', setup: 'ติดตั้ง', support: 'สนับสนุน', faq: 'FAQ',
		gallery: 'ลุคในเกม', buy: 'ซื้อ Sea of Thieves Cheats', viewStore: 'ดูร้านค้า', setupGuide: 'คู่มือติดตั้ง',
		checkStatus: 'ตรวจสอบสถานะ', overview: 'ภาพรวม Sea of Thieves Cheats', viewFeatures: 'ดูฟีเจอร์', contactSupport: 'ติดต่อฝ่ายสนับสนุน',
		inGame: 'ลุคในเกม', fullGuide: 'Sea of Thieves Cheats — คู่มือฉบับสมบูรณ์',
	},
	vi: {
		features: 'Tính năng', store: 'Cửa hàng', status: 'Trạng thái', setup: 'Cài đặt', support: 'Hỗ trợ', faq: 'FAQ',
		gallery: 'Giao diện trong game', buy: 'Mua Sea of Thieves Cheats', viewStore: 'Xem cửa hàng', setupGuide: 'Hướng dẫn cài đặt',
		checkStatus: 'Kiểm tra trạng thái', overview: 'Tổng quan Sea of Thieves Cheats', viewFeatures: 'Xem tính năng', contactSupport: 'Liên hệ hỗ trợ',
		inGame: 'Giao diện trong game', fullGuide: 'Sea of Thieves Cheats — Hướng dẫn đầy đủ',
	},
	uk: {
		features: 'Функції', store: 'Магазин', status: 'Статус', setup: 'Встановлення', support: 'Підтримка', faq: 'FAQ',
		gallery: 'Вигляд у грі', buy: 'Купити Sea of Thieves Cheats', viewStore: 'Переглянути магазин', setupGuide: 'Гайд з встановлення',
		checkStatus: 'Перевірити статус', overview: 'Огляд Sea of Thieves Cheats', viewFeatures: 'Дивитися функції', contactSupport: "Зв'язатися з підтримкою",
		inGame: 'Вигляд у грі', fullGuide: 'Sea of Thieves Cheats — Повний гайд',
	},
	cs: {
		features: 'Funkce', store: 'Obchod', status: 'Stav', setup: 'Instalace', support: 'Podpora', faq: 'FAQ',
		gallery: 'Vzhled ve hře', buy: 'Koupit Sea of Thieves Cheats', viewStore: 'Zobrazit obchod', setupGuide: 'Průvodce instalací',
		checkStatus: 'Zkontrolovat stav', overview: 'Přehled Sea of Thieves Cheats', viewFeatures: 'Zobrazit funkce', contactSupport: 'Kontaktovat podporu',
		inGame: 'Vzhled ve hře', fullGuide: 'Sea of Thieves Cheats — Kompletní průvodce',
	},
	ro: {
		features: 'Funcții', store: 'Magazin', status: 'Status', setup: 'Instalare', support: 'Suport', faq: 'FAQ',
		gallery: 'Aspect în joc', buy: 'Cumpără Sea of Thieves Cheats', viewStore: 'Vezi magazinul', setupGuide: 'Ghid de instalare',
		checkStatus: 'Verifică statusul', overview: 'Prezentare Sea of Thieves Cheats', viewFeatures: 'Vezi funcțiile', contactSupport: 'Contactează suportul',
		inGame: 'Aspect în joc', fullGuide: 'Sea of Thieves Cheats — Ghid complet',
	},
	sv: {
		features: 'Funktioner', store: 'Butik', status: 'Status', setup: 'Installation', support: 'Support', faq: 'FAQ',
		gallery: 'Utseende i spelet', buy: 'Köp Sea of Thieves Cheats', viewStore: 'Visa butik', setupGuide: 'Installationsguide',
		checkStatus: 'Kontrollera status', overview: 'Sea of Thieves Cheats-översikt', viewFeatures: 'Visa funktioner', contactSupport: 'Kontakta support',
		inGame: 'Utseende i spelet', fullGuide: 'Sea of Thieves Cheats — Fullständig guide',
	},
};
...
function buildFeatures(locale, u, p) {
	...
	const t = {
		es: {
			...
			p: [
				...
				['Reconstruimos tras parches grandes de Sea of Thieves o EAC.', 'Revisa Estado antes de jugar después de un día de parche.', 'Verifica cambios oficiales en las notas de Sea of Thieves y la Wiki de Sea of Thieves antes de ajustar overlays.'],
			],
			list: [
		...
		fr: {
			...
			p: [
				...
				['Nous reconstruisons après les gros patchs Sea of Thieves ou EAC.', 'Consultez Statut avant de jouer après un jour de patch.', 'Vérifiez les notes Sea of Thieves et le Wiki Sea of Thieves avant d\'ajuster les overlays.'],
			],
			list: [
		...
		de: {
			...
			p: [
				...
				['Wir bauen nach großen Sea of Thieves- oder EAC-Patches neu.', 'Prüfe Status vor dem Spielen nach Patch-Tagen.', 'Offizielle Änderungen in Sea of Thieves-Patchnotes und Sea of Thieves Wiki prüfen, bevor du Overlays anpasst.'],
			],
			list: [
	...
	if (!content) {
		return {
			title: clampTitle(`${u.features} 2026 | ESP, Aimbot & Radar | Sea of Thieves Cheats`),
			...
			intro: p.s1(`${u.features} für Sea of Thieves auf ${p.win}.`),
			ctaPrimary: u.buy,
...
function simplePageTitle(h1, enTitle) {
	...
	const suffix = pipe >= 0 ? enTitle.slice(pipe).replace(/\s*Guide\s*$/i, '').trim() : '| Sea of Thieves Cheats';
	...
	for (const [pageId, enPage] of Object.entries(simplePagesEn)) {
		...
		pages[pageId] = {
			...
			description: clampDesc(
				stripZadeyoFromMeta(
					`${h1} for Sea of Thieves ranked & Arena on Windows PC — ${focus}. ${p.delivery}. Official sea of thieves cheats at seaofthievescheats.com.`,
				),
			),
			h1,
			intro: p.s1(`${h1}. ${focus}.`),
...
function getNativeSimpleContent(locale, u, p) {
	...
	mk('sea-of-thieves-esp', {
		h1: modulePageH1('sea-of-thieves-esp', L) ?? 'Sea of Thieves ESP',
		intro: sectionParas(L, 'sea-of-thieves-esp', 'intro', p)[0],
		sections: [
			{ h2: sectionTitle(L, 'whatEspShows'), paragraphs: sectionParas(L, 'sea-of-thieves-esp', 0, p), list: sectionList(L, 'sea-of-thieves-esp', 0) },
			{ h2: sectionTitle(L, 'whenToUse'), paragraphs: sectionParas(L, 'sea-of-thieves-esp', 1, p), list: sectionList(L, 'sea-of-thieves-esp', 1) },
			{ h2: sectionTitle(L, 'nextSteps'), paragraphs: sectionParas(L, 'sea-of-thieves-esp', 2, p), list: sectionList(L, 'sea-of-thieves-esp', 2, L) },
		],
	});

	mk('sea-of-thieves-aimbot', {
		h1: modulePageH1('sea-of-thieves-aimbot', L) ?? 'Sea of Thieves Aimbot',
		intro: sectionParas(L, 'sea-of-thieves-aimbot', 'intro', p)[0],
		sections: [
			{ h2: sectionTitle(L, 'controls'), paragraphs: sectionParas(L, 'sea-of-thieves-aimbot', 0, p), list: sectionList(L, 'sea-of-thieves-aimbot', 0) },
			{ h2: sectionTitle(L, 'playStyles'), paragraphs: sectionParas(L, 'sea-of-thieves-aimbot', 1, p), list: sectionList(L, 'sea-of-thieves-aimbot', 1) },
			{ h2: sectionTitle(L, 'nextSteps'), paragraphs: sectionParas(L, 'sea-of-thieves-aimbot', 2, p), list: sectionList(L, 'sea-of-thieves-aimbot', 2, L) },
		],
	});
...
const SECTION_TITLES = {
	...
	whatAreCheats: { es: '¿Qué son los trucos de Sea of Thieves?', fr: 'Que sont les triches Sea of Thieves ?', de: 'Was sind Sea of Thieves Cheats?', pt: 'O que são cheats de Sea of Thieves?', it: 'Cosa sono i cheat Sea of Thieves?', nl: 'Wat zijn Sea of Thieves cheats?', pl: 'Czym są cheaty Sea of Thieves?', ru: 'Что такое читы Sea of Thieves?', tr: 'Sea of Thieves hileleri nedir?', ar: 'ما هي غش Sea of Thieves؟', ja: 'Sea of Thievesチートとは？', ko: 'Sea of Thieves 치트란?', zh: '什么是Sea of Thieves作弊？', hi: 'Sea of Thieves cheats क्या हैं?', id: 'Apa itu cheat Sea of Thieves?', th: 'Sea of Thieves cheats คืออะไร?', vi: 'Cheat Sea of Thieves là gì?', uk: 'Що таке чіти Sea of Thieves?', cs: 'Co jsou sea of thieves cheaty?', ro: 'Ce sunt cheats Sea of Thieves?', sv: 'Vad är Sea of Thieves cheats?' },
	whatIncludes: { es: 'Qué incluye Sea of Thieves Cheats', fr: 'Ce que Sea of Thieves Cheats inclut', de: 'Was Sea of Thieves Cheats enthält', pt: 'O que o Sea of Thieves Cheats inclui', it: 'Cosa include Sea of Thieves Cheats', nl: 'Wat Sea of Thieves Cheats bevat', pl: 'Co zawiera Sea of Thieves Cheats', ru: 'Что входит в Sea of Thieves Cheats', tr: 'Sea of Thieves Cheats neleri içerir', ar: 'ماذا يتضمن Sea of Thieves Cheats', ja: 'Sea of Thieves Cheatsの内容', ko: 'Sea of Thieves Cheats 포함 사항', zh: 'Sea of Thieves Cheats包含什么', hi: 'Sea of Thieves Cheats में क्या शामिल है', id: 'Apa yang termasuk Sea of Thieves Cheats', th: 'Sea of Thieves Cheats รวมอะไรบ้าง', vi: 'Sea of Thieves Cheats bao gồm gì', uk: 'Що входить до Sea of Thieves Cheats', cs: 'Co obsahuje Sea of Thieves Cheats', ro: 'Ce include Sea of Thieves Cheats', sv: 'Vad Sea of Thieves Cheats innehåller' },
