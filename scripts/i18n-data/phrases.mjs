...
const KW = {
	...
	cheats: 'sea of thieves cheats',
	hack: 'sea of thieves cheat',
	esp: 'Sea of Thieves ESP',
	wallhack: 'ESP wallhack',
	radar: 'radar hack',
	aimbot: 'Sea of Thieves Aimbot',
...
export const phrases = {
	es: {
		buy: 'Comprar Sea of Thieves Cheats', undetected: 'indetectables', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'Contacta support@seaofthievescheats.com para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Sea of Thieves Cheats', undetected: 'indétectables', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'Contactez support@seaofthievescheats.com pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Sea of Thieves Cheats kaufen', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'support@seaofthievescheats.com für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Sea of Thieves Cheats', undetected: 'indetectáveis', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'Contacte support@seaofthievescheats.com para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Sea of Thieves Cheats', undetected: 'indetectable', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'Contatta support@seaofthievescheats.com per supporto o richieste legali.',
	},
	nl: {
		buy: 'Sea of Thieves Cheats kopen', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'support@seaofthievescheats.com voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Sea of Thieves Cheats', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'support@seaofthievescheats.com w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Sea of Thieves Cheats', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'support@seaofthievescheats.com для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Sea of Thieves Cheats satın al', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'Destek ve yasal sorular için support@seaofthievescheats.com.',
	},
	ar: {
		buy: 'اشترِ Sea of Thieves Cheats', undetected: 'غير مكتشف', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'support@seaofthievescheats.com للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Sea of Thieves Cheatsを購入', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'サポート・法務: support@seaofthievescheats.com',
	},
	ko: {
		buy: 'Sea of Thieves Cheats 구매', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => '지원 및 법무: support@seaofthievescheats.com',
	},
	zh: {
		buy: '购买 Sea of Thieves Cheats', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => '支持与法务：support@seaofthievescheats.com',
	},
	hi: {
		buy: 'Sea of Thieves Cheats खरीदें', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'सहायता: support@seaofthievescheats.com',
	},
	id: {
		buy: 'Beli Sea of Thieves Cheats', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'support@seaofthievescheats.com untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Sea of Thieves Cheats', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'support@seaofthievescheats.com สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Sea of Thieves Cheats', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'support@seaofthievescheats.com cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Sea of Thieves Cheats', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'support@seaofthievescheats.com для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Sea of Thieves Cheats', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'support@seaofthievescheats.com pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Sea of Thieves Cheats', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'support@seaofthievescheats.com pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Sea of Thieves Cheats', undetected: 'undetected', maps: 'islands, outposts, and sea routes',
		...
		legal: () => 'support@seaofthievescheats.com för support och juridik.',
	},
};
