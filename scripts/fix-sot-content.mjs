#!/usr/bin/env node
/**
 * Second-pass cleanup: remove Isle gameplay leftovers after adapt-seaofthieves.mjs
 * Run: node scripts/fix-sot-content.mjs
 */
...
const REPLACEMENTS = [
	...
	['The Isle Hacks', 'Sea of Thieves Cheats'],
	['Isle Hacks', 'Sea of Thieves Cheats'],
	['Isle Hack Shops', 'Sea of Thieves Cheat Shops'],
	['Isle Hack Shop', 'Sea of Thieves Cheat Shop'],
	['Isle Hack', 'Sea of Thieves Cheat'],
	['Isle wallhack', 'Sea of Thieves wallhack'],
	['Isle radar', 'Sea of Thieves radar'],
	['Isle Wiki', 'Sea of Thieves Wiki'],
	['Isle Intel', 'Sea of Thieves Intel'],
	['Isle ESP', 'Sea of Thieves ESP'],
	['Isle Aimbot', 'Sea of Thieves Aimbot'],
	['Isle cheats', 'Sea of Thieves cheats'],
	['Isle cheat', 'Sea of Thieves cheat'],
	['Isle hacks', 'Sea of Thieves cheats'],
	['Isle hack', 'Sea of Thieves cheat'],
	['Isle esp', 'Sea of Thieves ESP'],
	['Isle aimbot', 'Sea of Thieves Aimbot'],
	['Two-Week Isle Hack Comparison Test', 'Two-Week Sea of Thieves Cheat Comparison Test'],
	['Typical Budget Isle Hack Shops', 'Typical Budget Sea of Thieves Cheat Shops'],

	// Broken doubles from partial migration
	['PvP match matches', 'PvP matches'],
	['raid match', 'raid'],
	['raid matches', 'matches'],
	['base matches and PvP matches', 'voyages, PvP sessions and ranked matches'],
	['base matches and PvP match matches', 'voyages, PvP sessions and ranked matches'],

	// Isle survival mechanics → Sea of Thieves mechanics
	...
	['growth tools', 'naval combat tools'],
	...
	['survival tips', 'sailing and PvP tips'],
	...
	['ESP markers for loot and bases in Sea of Thieves', 'ESP markers for loot and bases in Sea of Thieves'],
	['Gateway', 'Map'],
	...
	['Sea of Thieves player tier list for herbivore and carnivore matches', 'Sea of Thieves weapon tier list for PvP and farming matches'],
	...
	// Misc cleanup
	['an Sea of Thieves's, 'a Sea of Thieves's],
	['what-is-an-sea-of-thieves-wallhack', 'what-is-a-sea-of-thieves-wallhack'],
	['EAC Anti-Cheat', 'EAC'],
	['Rare service health', 'Sea of Thieves server status'],
	['Rare ships', 'Facepunch ships'],
	['Rare (${EXT.finals})', 'Facepunch (${EXT.finals})'],
];

const TEXT_EXTENSIONS = new Set(['.ts', '.tsx', '.js', '.mjs', '.astro', '.json', '.md', '.mdc', '.txt']);
const TARGET_DIRS = ['src', 'scripts', 'public', 'functions'];
const SKIP_FILES = new Set(['adapt-tarkov.mjs', 'adapt-theisle.mjs', 'adapt-seaofthieves.mjs', 'fix-sot-content.mjs']);
