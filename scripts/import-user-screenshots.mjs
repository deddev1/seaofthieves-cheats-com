...
const USER_SCREENSHOTS = [
	{
		...
		file: 'sea-of-thieves-esp-player-tags.webp',
	},
	{
		source:
		...
		file: 'sea-of-thieves-wallhack-skeleton.webp',
	},
	{
		source:
		...
		file: 'sea-of-thieves-aimbot-sniper.webp',
	},
	{
		source:
		...
		file: 'sea-of-thieves-aimbot-skeleton.webp',
	},
	{
		source:
		...
		file: 'sea-of-thieves-esp-radar.webp',
	},
	{
		source:
		...
		file: 'sea-of-thieves-cheats-combat.webp',
	},
];
...
const REMOVE_PREFIXES = [
	...
	'sea-of-thieves-cheats-cover',
	'sea-of-thieves-cheats-esp-wallhack',
	'sea-of-thieves-cheats-hero',
	'sea-of-thieves-cheats-logo',
	'sea-of-thieves-cheats-package',
	'rust-header-art',
...
async function generateResponsiveVariants() {
	const heroSource = path.join(imagesDir, 'sea-of-thieves-esp-player-tags.webp');
	const heroMeta = await sharp(heroSource).metadata();

	for (const width of HERO_WIDTHS) {
		if (heroMeta.width && width > heroMeta.width) continue;
		const file = `sea-of-thieves-esp-player-tags-${width}w.webp`;
	...
	for (const { file } of USER_SCREENSHOTS) {
		if (file === 'sea-of-thieves-esp-player-tags.webp') continue;
...
async function generateFavicons() {
	const logoPath = path.join(imagesDir, 'sea-of-thieves-cheats-logo.png');
